...
public class ViewVitalPanel extends javax.swing.JPanel {
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if (selectedRow >= 0) {
            VitalSigns vitalSigns = (VitalSigns) tableVitalSign.getValueAt(selectedRow, 0);
            temperatureTextField.setText(String.valueOf(vitalSigns.getTemperature()));
            bloodPressureTextField.setText(String.valueOf(vitalSigns.getBloodPressure()));
            pulseTextField.setText(String.valueOf(vitalSigns.getPulse()));
            dateTextField.setText(vitalSigns.getDate());
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBtnActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            JOptionPane.showMessageDialog(null, "Vital Signs Not updated");
        }
    }//GEN-LAST:event_confirmBtnActionPerformed
    private void setFieldEnabled(Boolean enable) {
